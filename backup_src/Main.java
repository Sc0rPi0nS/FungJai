...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        ...
        stage.getIcons().add(new Image("file:C:/Users/iamni/OneDrive/Documents/NetBeansProjects/FungJai/pictures/icon1.png"));

        // ===== Background =====
        Image bg = new Image("file:C:/Users/iamni/OneDrive/Documents/NetBeansProjects/FungJai/pictures/bg1.png");
        Image bgPlay  = new Image("file:C:/Users/iamni/OneDrive/Documents/NetBeansProjects/FungJai/pictures/test.gif");
        ImageView bgView = new ImageView(bg);
        bgView.setScaleX(0.843);
        bgView.setScaleY(0.843);
        bgView.setLayoutX(-548);
        bgView.setLayoutY(-222);
        ImageView bgPlayView = new ImageView(bgPlay);
        bgPlayView.setScaleX(0.8);
        bgPlayView.setScaleY(0.8);
        bgPlayView.setLayoutX(-740);
        bgPlayView.setLayoutY(-250);
        bgPlayView.setVisible(false);
        
        // music player ====
        Media media = new Media("file:///C:/Users/iamni/OneDrive/Documents/NetBeansProjects/FungJai/song/song1.mp3");
